...
var prof = document.forms['post_form']['profession_1'];

var duration = document.forms['post_form']['duration_1'];

var numbers = /^[0-9]+$/;

var budget1 = document.forms['post_form']['price'];

var format = /^[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]*$/;

var phone = document.forms['post_form']['phone_no'];

var address_1 = document.forms['post_form']['location'];
